...
import ridingCitiesImg from '../images/RidingCities/ridingcities.webp'
import ridingCitiesImg2 from '../images/RidingCities/ridingCitiesPlanning.webp'
...
import printItImg from '../images/PrintIt/printit.webp'
import printItImg2 from '../images/PrintIt/printitRoller.webp'
...
export const works = [
    ...
    },
    {
        ...
        "fullDescription": "Print It est un projet d’introduction au JavaScript.<br/><br/>Print It est un site d’entreprise d’impression sur lequel j’ai eu à créer un roller pour les images en JavaScript. Il s’agit d’un des plus petits projets que j’ai eu à faire durant ma formation.<br/><br/>",
        "homePage": false,
        "isOnline": true
    },
    {
    ...
    },
    {
        ...
        "fullDescription": "Premier projet de programmation de ma formation Intégrateur Web chez OpenClassrooms, Riding cities m’a permis de me plonger dans le grand bain.<br/><br/>Avec ce projet, j’ai commencé à apercevoir le monde du développement web professionnel. <br/>Initiation aux animations CSS, apprentissages des conventions sémantiques du HTML, ce projet était pour moi l’occasion de mettre officiellement un pied dans le monde de la création de sites web.<br/><br/>",
        "homePage": false,
        "isOnline": true
    }
]